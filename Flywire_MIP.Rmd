...
LC_uDNb05.JRC2018U = xform_brain(LC_uDNb05, sample = "FAFB14", reference = JRC2018U)
...
im = as.im3d(xyzmatrix(LC_uDNb05.JRC2018U), JRC2018Umip)

# write out a nrrd file
# dir.create("flywire_MIP")
write.im3d(im, paste( "./flywire_MIP/LC_uDNb05.JRC2018U.nrrd"))
