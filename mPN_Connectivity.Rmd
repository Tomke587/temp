...
test= c("610274046", "610274029", "5812996641")
...
common = neuprint_common_connectivity(NOIhemibrainid, prepost = "POST") # could use 'post' for downstream
dim(common) 
common
# 1316245799 M_spPN4t9
# 1663021115 fragment
```
...
sm=flywire_adjacency_matrix(NoIname$post_id)
NoI_conn=sm
...
Single neurons plot and connectivity
Flywire neurons plot
```{r plot flywire neurons}
neuron_R =	"720575940612616354"
neuron_L =	"720575940612379282"
...
rgl.snapshot(filename = "M_l2PNl20_Flywire.png" , fmt = "png" )
```
...
write.csv(Partner_summary_in_types_5, file = "M_l2PNl20_partner_summary_in_5.csv")
...
write.csv(Partner_summary_out_types_5, file = "M_l2PNl20_partner_summary_out_5.csv")
...
ggsave("M_l2PNl20_Partner_summary_out_types_50.png")
Partner_out_plot
```